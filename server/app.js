...
const { CreateProduct, GetAllProduct, AddReview, UpdateProduct, GetProduct,
     DeleteReview , GetAllReview ,DeleteProduct, AdminGetAllProducts, GetTopSellProducts} = require('./routes/productroutes');
