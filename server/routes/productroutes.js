...
const { getallproduct, createproduct, updateproduct, deleteproduct, getproduct, addreview,
     getallreview, deletereview, Admingetallproducts, gettopproducts } = require('../controllers/productcontroller');
